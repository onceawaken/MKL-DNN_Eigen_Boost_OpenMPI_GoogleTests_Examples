macro(target_copy_extern_libs TARGET EXTERN_LIB_DIR)
    ...
    foreach (LIB IN ITEMS ${extra_macro_args})
        target_copy_extern_lib(${TARGET} ${EXTERN_LIB_DIR} ${LIB})
    endforeach ()


endmacro()

macro(target_copy_extern_lib TARGET EXTERN_LIB_DIR EXTERN_LIB)

    get_runtime_output_dir(${TARGET})
    message("RUNTIME_OUTPUT_DIR = ${RUNTIME_OUTPUT_DIR}")

    set(source ${EXTERN_LIB_DIR}/lib${EXTERN_LIB}.so)
    set(destination ${RUNTIME_OUTPUT_DIR}/lib${EXTERN_LIB}.so)

    message(">>> TARGET ${TARGET} GET COPY OF LIB ${EXTERN_LIB}")

...
set_target_properties(MKLDNN::mkldnn PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmkldnn.so.0.18.1.0"
  IMPORTED_SONAME_RELEASE "libmkldnn.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS MKLDNN::mkldnn )
list(APPEND _IMPORT_CHECK_FILES_FOR_MKLDNN::mkldnn "${_IMPORT_PREFIX}/lib/libmkldnn.so.0.18.1.0" )
